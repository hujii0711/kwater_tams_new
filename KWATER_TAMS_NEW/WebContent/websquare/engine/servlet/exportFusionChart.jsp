...
%><%
    ...
    String WEBSQUARE_HOME = DefaultRequestDispatcher.getWebsquareHome();
    if( WEBSQUARE_HOME == null || WEBSQUARE_HOME.equals( "" ) ) {
        WEBSQUARE_HOME = FileUtil.toPlatform(System.getProperty("WEBSQUARE_HOME"));
    }
    
    if( WEBSQUARE_HOME == null ) {
        WEBSQUARE_HOME = FileUtil.toPlatform(System.getProperty("osgi.install.area"));
    }
